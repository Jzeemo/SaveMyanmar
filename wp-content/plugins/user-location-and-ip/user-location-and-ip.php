...
* Description: Allows you to insert user's IP address, Location, ISP, City, Country, Country Flag in your WordPress blog post and page using simple shortcode.
* License: GPL2
...
class user_location_and_ip
{
    public function __construct() {
    	add_shortcode( 'useriploc', array( $this, 'user_location_and_ip' ));
    }
